...
- 방탈출 게임은 기본적으로 아이템을 탐색하고 그 아이템으로 방을 탈출해야 하는데, 아이템을 찾으려면 방을 일일이 뒤져야 해서 시간도 오래 걸리고 짜증이 나기 때문에 주어진 퍼즐을 해결하면 다음 퍼즐로 이어지는 힌트를 주어 플레이어가 헤매지 않게 하고싶다.

### 서브 컨셉 1 : 수수께끼 

- 게임 안에 미니게임으로 퍼즐을 넣고싶다.
