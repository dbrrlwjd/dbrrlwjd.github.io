...
### [6. 게임시스템디자인](#게임-시스템-디자인)
### [7. 게임 오브젝트 분해](#게임-오브젝트-분해)
### [8. 파라미터](#파라미터)
### [9. 행동](#행동)
### [10. 상태](#상태)
### [11. 플레이어 캐릭터 속성](#플레이어-캐릭터-속성)
### [12. 게임의 규칙](#게임의-규칙)
### [13. 게임에서 사용될 공식](#게임에서-사용될-공식)
### [14. 개발 요구사항 and 흐름도](#개발-요구사항-and-흐름도)
### [15. 요구사항](#요구사항)
### [16. 시간별 흐름도 flowchart](#시간별-흐름도-flowchart)
### [17. 키보드 이벤트에 대한 흐름도](#키보드-이벤트에-대한-흐름도)
### [18. 용어정리](#용어정리)
### [19. 스토리보드](#스토리보드)
...
|속성|영문명칭|설명|
|:---:|:---:|:---:|
|잠김|lock|플레이어가 열쇠를 모두 획득하지 못한 상태이면 열리지 않음|
|열쇠획득|key_find|플레이어가 열쇠를 획득하였는가|
...
|속성|영문명칭|설명|
|:---:|:---:|:---:|
|잠김|lock|플레이어가 해당하는 힌트를 획득하지 못한 상태이면 열리지 않음|
|힌트획득|hint_find|플레이어가 힌트를 획득하였는가|
